...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 12, 2024 at 06:51 PM
...
(1, 16, 'Xiaomi 11T Celestial Blue', 644.99, 1),
...
(3, 5, 1, 'Jewel', '0898127346', 'joepro1020@gmail.com', 'credit card', 'no', 0.00, '-', 1199.99, '2024-01-23 20:12:27', 'pending', 'processing', 1),
(3, 9, 1, 'Jewel', '0895743261', 'joe@joe.com', 'credit card', 'no', 0.00, '-', 789.20, '2024-01-23 20:12:27', 'pending', 'processing', 1),
(4, 5, 1, 'Jewel', '0884519732', 'joepro@gmail.com', 'cash on delivery', 'no', 0.00, '-', 1199.99, '2024-01-24 22:00:05', 'pending', 'processing', 3),
(5, 18, 1, 'Jewel', '0877888888', 'joepro@gmail.com', 'credit card', 'no', 0.00, '-', 157.99, '2024-02-12 00:39:17', 'pending', 'processing', 1);
...
(5, 'Samsung Galaxy S21 Ultra Pure Black', 'The Samsung Galaxy S21 Ultra is a premium flagship smartphone with cutting-edge features, a top-of-the-line camera system, and powerful hardware.', 'Samsung', '2021-01-29', 2, 'Exynos 2100', '512GB', '16GB', 4, '108MP (wide), 12MP (ultrawide), 10MP (periscope telephoto), 10MP (telephoto)', '6.8 in', '5000 mAh', 'Phantom Black', 1029.99, 'Samsung Galaxy S21 Ultra 1.png', 'Samsung Galaxy S21 Ultra 2.png', 'Samsung Galaxy S21 Ultra 3.png'),
...
(1, 1, '2024-01-21 08:42:15', 'Jewel', 'joepro@gmail.com', '0878146923', 'Samsung', 'I\'ve been noticing my Samsung phone\'s battery draining faster than usual. It\'s frustrating because I can\'t seem to keep it charged for a full day. There are probably a few reasons for this, like the battery getting old, or maybe I\'m using some apps that are draining the battery more quickly. I\'ve tried adjusting some settings to use less battery, but it doesn\'t seem to be enough. I might need to take it in to a service technician to have them take a look and see if they can diagnose the exact cause. Maybe they\'ll need to replace the battery.', 0, 'cash on delivery', 'pending', 'yes', 53.52, 'Flat №: new, Street: new, City: new, State: new, Country: new, Post code: 15234'),
...
(1, 'User', 'user@user.com', '12dea96fec20593566ab75692c9949596833adc9', 0, 'sung-jinwoo-death-look.png', '2023-12-15'),
...
(5, 'Sung Jinwoo', 'sungjinwoo10@jinwoo.com', 'f05f5d4cdeb74b5ba7746105ab8c9adaaf246808', 1, 'sung-jin-woo-cool.png', '2024-03-03'),
...
(12, 'new', 'new@new.com', '15cfbdb2bb121a3111fa4e0d6058aefc5e05211f', 0, 'katsuki-bakugo.png', '2024-05-23'),
(14, 'mu', 'mu@mu.com', 'e55ba25f51e6955bfa07f7d489cd24297c86f0e2', 1, 'logedin.png', '2024-05-23');
...
(1, 35, 'Realme GT NEO 3 Asphalt Black', 989.99);
